...
*/
 var cities = {
	'Punjab' : [
		'Fazilka', 'Abohar', 'Patiala','Amritsar','Barnala','Gurdaspur'
		],
	'Haryana' : [
		'Ambala','Faridabad','Fatehabad','Sirsa','Hisar','Gurgaon'
		],
	'Rajasthan' : [
		'Jhunjhnu','Bikaner','Ganganagar','Hanumangarh','Jaipur','Jaisalmer'
		],
	'Gujrat' : [
		'Ahmedabad','Amreli','Anand','Aravali','Palanpur','Rajkot','Surat',
		],
	'Maharashtra' : [
		'Ahmednagar','Akola','Amravati','Aurangabad','Bhandara','Chandrapur','Kohlapur','Nagpur'
		],
	'Jammu And Kashmir' : [
		'Balakot','Poonch','Srinagar','Pulwama'
		],		
 }
 ...
 var City = function() {
	...
	this.showProvinces = function(element) {
		var str = '<option selected disabled>Select State</option>';
